...
var Grid = function () {
    ...
    _createClass(Grid, [{
        ...
        value: function build() {
            ...
            var rowGroupClasses = ["row_g_top", "row_g_middle", "row_g_buttom"];
            var colGroupClasses = ["col_g_left", "col_g_center", "col_g_right"];

            var $cells = matrix.map(function (rowsValues) {
                return rowsValues.map(function (cellValue, colIndex) {
